...
const PersonalNavbar = () => {
  ...
  const sideList = (slider) => (
    ...
    >
      <Avatar className={classes.personalPicture} src={personalPicture} alt="Sharif" />
      <Divider />
      <List>
        ...
        <div className="row">
          ...
          <Navbar  expand="lg">
              <Navbar.Brand href="#home"><Link to="/" style={{ color: "tan", textDecoration: "none" }} onClick={toggleSlider("right", true)} className="yahia">
                <span className="yahia-s">Mahedi's</span> <span className="yahia-s-portfolio">Portfolio</span>
              </Link></Navbar.Brand>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Link to="/" style={{ color: "tan", textDecoration: "none", }} className="navbar-container">
                    ...
                    <Link to="/projects" style={{ color: "tan", textDecoration: "none" }} className="navbar-container">
                      Projects
              </Link>
                    ...
                    <Link to="/contact" style={{ color: "tan", textDecoration: "none" }} className="navbar-container">
                      Contacts
              </Link>
